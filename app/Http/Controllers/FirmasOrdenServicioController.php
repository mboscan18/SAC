...
use SAC\Http\Requests\FirmasOrdenServicioRequest;
use SAC\Http\Controllers\Controller;
use Illuminate\Contracts\Auth\Guard;

class FirmasOrdenServicioController extends Controller
{
    ...
    {
        FirmasOrdenServicio::create($request->all());
    ...
    {
        $firma = FirmasOrdenServicio::find($id);
        $firma->delete();
