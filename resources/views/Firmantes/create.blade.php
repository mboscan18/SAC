@extends('layouts.principal')
  @section('page-title', 'Crear Firmnte')

@section('titulo')  
    <h3 class="page-header"><i class="fa fa-pencil"></i> Crear Firmante</h3>
@endsection
@section('lugar')
    </li><li><i class="fa fa-pencil"></i><a href="{!!URL::to('Firmantes')!!}"> Firmantes</a></li>
@endsection
@section('accion')
  <li><i class="fa fa-plus"></i> Crear Firmante</li>
@endsection
              ...
              <div class="col-lg-10 col-md-10 col-sm-10">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" >
                      {!!Form::open(['route'=>'Firmantes.store', 'method'=>'POST'])!!}
