<div class="row" style="background-color: #d4e2ed; color: #20374a">	
	...
	<div class="col-lg-4 col-md-4 col-sm-4" >
		<div id="div_MontoEjecutadoVal"> 
		  ...
		  {!!Form::hidden('montoEjecutadoValuacion',$montoEjecutadoValuacion,['id'=>'montoEjecutadoValuacion'])!!}
		</div>
	</div>
	<div class="col-lg-2 col-md-2 col-sm-2" >
	...
	<div class="col-lg-4 col-md-4 col-sm-4" >
		<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($acumuladoDescuentosAnticipos, 2, ',', '.'),[ 'id'=>''])!!}
		  {!!Form::hidden('acumuladoDescuentosAnticipos',$acumuladoDescuentosAnticipos,['id'=>'acumuladoDescuentosAnticipos'])!!}
	</div>
	<div class="col-lg-2 col-md-2 col-sm-2" >
	...
	<div class="col-lg-4 col-md-4 col-sm-4" >
		<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($acumuladoDescuentosAdelantos, 2, ',', '.'),[ 'id'=>''])!!}
		  {!!Form::hidden('acumuladoDescuentosAdelantos',$acumuladoDescuentosAdelantos,['id'=>'acumuladoDescuentosAdelantos'])!!}
	</div>
	<div class="col-lg-2 col-md-2 col-sm-2" >
	...
	<div class="col-lg-4 col-md-4 col-sm-4">
		<div id="div_MontoEjecutadoValConDescuentos"> 
			<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($montoEjecutadoValuacionConDescuentos, 2, ',', '.'),[ 'id'=>''])!!}
			  {!!Form::hidden('montoEjecutadoValuacionConDescuentos',$montoEjecutadoValuacionConDescuentos,['id'=>'montoEjecutadoValuacionConDescuentos'])!!}
		</div>	  
	</div>
	<div class="col-lg-2 col-md-2 col-sm-2" >
		...
		<br>&nbsp;</br>
			...
			<div class="col-lg-4 col-md-4 col-sm-4" id="MontoAnticipo">
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($montoAnticipos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('montoAnticipos',$montoAnticipos,['id'=>'montoAnticipos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
			...
			<div class="col-lg-4 col-md-4 col-sm-4" >
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($descuentosAnticipos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('descuentosAnticipos',$descuentosAnticipos,['id'=>'descuentosAnticipos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
			...
			<div class="col-lg-4 col-md-4 col-sm-4" >
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($diferenciaAnticipos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('diferenciaAnticipos',$diferenciaAnticipos,['id'=>'diferenciaAnticipos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
		...
		<br>&nbsp;</br>
			...
			<div class="col-lg-4 col-md-4 col-sm-4" id="MontoAdelanto">
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($montoAdelantos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('montoAdelantos',$montoAdelantos,['id'=>'montoAdelantos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
			...
			<div class="col-lg-4 col-md-4 col-sm-4" >
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($descuentosAdelantos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('descuentosAdelantos',$descuentosAdelantos,['id'=>'descuentosAdelantos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
			...
			<div class="col-lg-4 col-md-4 col-sm-4" >
				<b>{{$valuacion->contrato->moneda->symbol}}</b> {!!Form::label('periodo',number_format($diferenciaAdelantos, 2, ',', '.'),[ 'id'=>''])!!}
				  {!!Form::hidden('diferenciaAdelantos',$diferenciaAdelantos,['id'=>'diferenciaAdelantos'])!!}
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2" >
...
<div class="row">
	<div class="form-group col-lg-12 col-md-12 col-sm-12 round-input">
		...
		{!!Form::select('tipo_Deduccion',array(
										...
										2 => 'Descuento'),null,['class'=>'form-control', 'onchange'=>'OpcionSeleccionada()', 'id'=>'tipo_Deduccion']
									)!!}
	</div>
</div>
<div class="row">	
	<div class="form-group col-lg-6 col-md-6 col-sm-6 round-input">
		...
		<div class="input-group">
		  ...
		  <input id="porcentaje_Deduccion_form" name="" type="text" class="form-control" onkeypress="return justNumbers(event);" placeholder="Porcentaje a Descontar" style="background-color: #d4e2ed; color: #20374a" >
		  {!!Form::hidden('porcentaje_Deduccion',null,['id'=>'porcentaje_Deduccion'])!!}
		</div>
	</div>	
	<div class="form-group col-lg-6 col-md-6 col-sm-6 round-input">
		...
		<div class="input-group">
		  ...
		  <input id="monto_Deduccion_form" name="" type="text" class="form-control" onkeypress="return justNumbers(event);" placeholder="Monto a Descontar" style="background-color: #d4e2ed; color: #20374a" >
		  {!!Form::hidden('monto_Deduccion',null,['id'=>'monto_Deduccion'])!!}

		</div>
	</div>
	<div style="text-align: center;">
		{!!Form::label('total','El monto a Descontar no puede ser mayor que el monto Ejecutado en la Valuacion.',['id'=>'MsjCantPasada',  'class'=>' tam-14'])!!}
	</div>	
</div>
...
{!!Form::hidden('',$valuacion->contrato->porcentajeAnticipo,['id'=>'porcentajeSugerido'])!!}
