<div class="row">
	<div class="form-group col-lg-3 col-md-3 col-sm-3 round-input">
		...
		{!!Form::text('nro_Boletin',null,['class'=>'form-control', 'onkeypress'=>'return justNumbers(event);', 'placeholder'=>'Numero de Boletín'])!!}
	</div>
	<div class="form-group col-lg-3 col-md-3 col-sm-3 round-input">
		{!!Form::label('num','Impuesto (IVA):')!!}
		<div class="input-group">
			{!!Form::text('IVA',null,['class'=>'form-control', 'onkeypress'=>'return justNumbers(event);', 'placeholder'=>'IVA'])!!}
