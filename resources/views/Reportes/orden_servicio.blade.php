...
<!--  - - - - - - - - - - - - - - - - - -->   
      ...
      <!-- PRESUPUESTO -->  
          ...
          <table  class="  " style="width: 100%; page-break-inside: avoid;">
                <tr >
                  <td style="text-align: center; width: 3%"  class="tabla tam-9 ">{{$datos->nro_Partida}}</td>
                  ...
                  <td style="text-align: right; width: 20%" class="tabla tam-10 col-lg-1" >{{number_format($datos->precio_Unitario, 2, ',','.')}}</td>
